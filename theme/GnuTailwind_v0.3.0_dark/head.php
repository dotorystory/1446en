...
<section id="topbar" class="bg-black text-white py-2 text-base">
  <div class="container mx-auto flex justify-between px-2 lg:px-0">
    ...
    <div class="lg:block" style="min-width:100px;">
      <!-- <i class="bi bi-envelope inline-flex items-center"><a href="mailto:info@gnutail.com"><span class="pl-1">web@industrialmarket.biz</span></a></i> -->
      <!-- <i class="bi inline-flex items-center">
        <a href="<?php echo G5_URL ?>/"><span style="font-style: normal">INDUSTRIALMARKET.BIZ</span></a>
      </i> -->
      <!-- <i class="bi bi-phone inline-flex items-center ml-4"><span> +82-10-7441-1446</span></i> -->
